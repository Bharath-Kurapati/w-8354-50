...
import { Shield, Database, Lock, Server, Key, FileCheck } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex items-center">
              <Database className="h-5 w-5 text-teal-400 mr-2" />
            ...
            <div className="flex items-center">
              <Key className="h-5 w-5 text-teal-400 mr-2" />
              <span className="text-gray-300">End-to-end data encryption</span>
            </div>
            <div className="flex items-center">
              <FileCheck className="h-5 w-5 text-teal-400 mr-2" />
              <span className="text-gray-300">GDPR compliant</span>
            </div>
            <div className="flex items-center">
              <Lock className="h-5 w-5 text-teal-400 mr-2" />
