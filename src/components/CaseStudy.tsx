    ...
    <section className="py-16 bg-white text-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
          <div>
            <div className="mb-8">
              <blockquote className="text-xl italic mb-4 text-gray-700">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">CPG Brand</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
              <div className="text-emerald-500 text-4xl font-bold mb-2">2×</div>
              <p className="text-gray-600">More accurate forecasts vs. previous methods</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
              <div className="text-emerald-500 text-4xl font-bold mb-2">95%</div>
              <p className="text-gray-600">Time saved on forecasting workflow</p>
            </div>
