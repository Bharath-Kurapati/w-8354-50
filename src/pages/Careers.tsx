        ...
        <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="max-w-6xl mx-auto">
              ...
              {/* Our Story Section - Updated without tiles */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        FeatureBox AI transforms how businesses manage their inventory through 
                        advanced AI and machine learning. Our platform combines deep supply chain expertise 
                        with powerful analytics to help businesses optimize inventory levels, 
                        reduce costs, and increase revenue. By analyzing historical data and market trends, 
                        we provide actionable insights that enable smarter decision-making.
                      </p>
                      <p className="text-gray-300 leading-relaxed">
                        As a Berkeley-born startup backed by UC Launch and Berkeley SkyDeck Pad-13, 
                        we roll-up a data scientist, supply chain manager, and business consultant into a single 
                        intuitive product that helps SMBs forecast inventory smarter and reclaim lost revenue up to 45%.
                      </p>
                    </div>
                    
                    <p className="text-xl font-bold text-brand-purple py-2">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        We placed #2 in the UC Launch Accelerator Program across the UC Network, dubbed as one of the most investable ideas. 
                        We got accepted to UC Berkeley Skydeck, Pad-13 program with early validation from VCs across the Berkeley eco-system. 
                        We are working with mid-market customers and have begun a meaningful number of pilots!
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                {/* Contact Section - Person's image removed */}
